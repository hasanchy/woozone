	...
	class WooZoneAssetDownload
	{
		...
		*/
		private function printBaseInterface()
		{
			global $wpdb;
?>
		<?php echo WooZone_asset_path( 'css', $this->module_folder . 'app.assets_download.css', false ); ?>
		...
		<?php echo WooZone_asset_path( 'js', $this->module_folder . 'app.assets_download.js', false ); ?>
...
<?php
		...
		public function verifyProdImageHash( $hash ) {
			...
			if ( !empty($res) && isset($res->media_id) ) {
				...
				if ( !empty($file) && $this->the_plugin->u->verifyFileExists($image_path) ) {
