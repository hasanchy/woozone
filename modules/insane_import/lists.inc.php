...
if ( in_array($WooZone->amzapi, array('newapi', 'creatorsapi')) ) {
//[new in api v5 / creatorsapi]
// MinReviewsRating
$WooZone_search_params['MinReviewsRating'] = array(
	0 		    => "Don't use it",
);
$WooZone_search_params['MinReviewsRating'] = array_merge( $WooZone_search_params['MinReviewsRating'], range(1, 5, 1) );

//[new in api v5 / creatorsapi]
// MinReviewsRating
$WooZone_search_params['MinSavingPercent'] = array(
	0 		    => "Don't use it",
);
$WooZone_search_params['MinSavingPercent'] = array_merge( $WooZone_search_params['MinSavingPercent'], range(1, 100, 1) );

// MinPercentageOff
$WooZone_search_params['DeliveryFlags'] = array(
	"" 		    			=> "Don't use it",
	"AmazonGlobal"			=> "Amazon Global",
...
//[new in api v5 / creatorsapi]
$WooZone_search_params['Sort'] = array();
$WooZone_search_params['Sort']['AvgCustomerReviews'] = 'Sorts results according to average customer reviews';
$WooZone_search_params['Sort']['Featured'] = 'Sorts results with featured items having higher rank';
$WooZone_search_params['Sort']['NewestArrivals'] = 'Sorts results with according to newest arrivals';
$WooZone_search_params['Sort']['PriceHighToLow'] = 'Sorts results according to most expensive to least expensive';
$WooZone_search_params['Sort']['PriceLowToHigh'] = 'Sorts results according to least expensive to most expensive';
$WooZone_search_params['Sort']['Relevance'] = 'Sorts results with relevant items having higher rank';
}

$__tmp = $WooZone_search_params;
$WooZone_search_params = array();
$WooZone_search_params['amazon'] = $__tmp;
...
*/
//ListingType
$WooZone_search_params['ebay'] = array_merge(array(
	'sortOrder' 			=> array(
...
$WooZone_search_params_sort = array();
$WooZone_search_params_sel = array();

//------------------------------
//:: AMAZON
$WooZone_search_params_sort['amazon'] = $WooZone_search_params['amazon']['Sort'];
$WooZone_search_params_sort['amazon']["relevancerank"] = 'Items ranked according to the following criteria: how often the keyword appears in the description, where the keyword appears (for example, the ranking is higher when keywords are found in titles), how closely they occur in descriptions (if there are multiple keywords), and how often customers purchased the products they found using the keyword.';
$WooZone_search_params_sort['amazon']["psrank"] = 'Bestseller ranking taking into consideration projected sales. The lower the value, the better the sales.';
$WooZone_search_params_sort['amazon']["release-date"] = 'Sorts by the latest release date from newer to older. See orig-rel-date, which sorts by the original release date.';

$WooZone_search_params_desc['amazon'] = array(
    ...
    'DeliveryFlags' 	=> 'Values Explained: <br/>AmazonGlobal = A delivery program featuring international shipping to certain Exportable Countries <br />FreeShipping = A delivery program featuring free shipping of an item <br />FulfilledByAmazon = Fulfilled by Amazon indicates that products are stored, packed and dispatched by Amazon <br />Prime = An offer for an item which is eligible for Prime Program',
    'Actor' 			=> '(string) Actor name associated with the item. You can enter all or part of the name.',
    'Artist' 			=> '(string) Artist name associated with the item. You can enter all or part of the name.',
    'Author' 			=> '(string) Author name associated with the item. You can enter all or part of the name.',
    'Title' 			=> '(string) Title associated with the item. Title searches are subset of Keywords searches. Use a Keywords search if a Title search does not return desired items.',
);

//------------------------------
//:: EBAY
$WooZone_search_params_sel['ebay']['sortOrder'] = array_merge(array(
...
$WooZone_search_params_sel['ebay']['Condition'] = array_merge(array(
...
$WooZone_search_params_sel['ebay']['Currency'] = array_merge(array(
...
$WooZone_search_params_sel['ebay']['ListingType'] = array_merge(array(
...
$WooZone_search_params_sel['ebay']['PaymentMethod'] = array_merge(array(
...
$WooZone_search_params_desc['ebay'] = array_merge(array(
