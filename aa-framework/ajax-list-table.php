...
;";
		...
		private function allowed_fields( $field_name ){

			$valid_fields_name = array();

			$valid_fields_name[] = 'id';
			$valid_fields_name[] = 'action';
			$valid_fields_name[] = 'assets';
			$valid_fields_name[] = 'publish';
			$valid_fields_name[] = 'provider';
			$valid_fields_name[] = 'country';
			$valid_fields_name[] = 'recurrency';
			$valid_fields_name[] = 'nb_tries';
			$valid_fields_name[] = 'status';
			$valid_fields_name[] = 'preview';
			$valid_fields_name[] = 'spinn_content';
			$valid_fields_name[] = 'provider';
			$valid_fields_name[] = 'country';
			$valid_fields_name[] = 'from_op_p1';


			if( !in_array($field_name, $valid_fields_name ) ){
				die("Invalid field_name");
			}
		}

		private function allowed_tables( $table_name ){
			$valid_tables_name = array();

			$valid_tables_name[] = 'amz_import_stats';
			$valid_tables_name[] = 'amz_queue';
			$valid_tables_name[] = 'amz_import_stats';

			if( !in_array($table_name, $valid_tables_name ) ){
				die("Invalid table_name");
			}
		}
			...
			if( $request['itemid'] > 0 ) {
				...
				if ( 1 ) {
					...
					if ( 1 ) {
						...
						$this->allowed_fields( $field_name );
						$this->allowed_tables( $table );
